...
ZGV:RegisterGuide("Dominion\\Malgrave (41-46)",
	...
	step
		...
		.' Recall to _Fort Vigilance_ - Transmat |goto Wilderrun 1263,-2072,-722 < 100 |c |q 8971
	step
		.click Ship to Illium##271199
		.' Press _Yes_ to travel to Illium |q Journey to Malgrave##8971/1 |goto Wilderrun 1152,-1985,-709
	step
		.talk Ringo Hax##265380
		..turnin Crimson Ore Shipment##9467 |goto Illium -3452,-742,-891
	step
		.' _Go up_ the staircase |goto -3609,-626,-879 < 10
		.click Ship to Malgrave##265394
		.' Press _Yes_ to travel to Fort Dominus in Malgrave |q Journey to Malgrave##8971/2 |goto -3636,-583,-858
	step
		'Press _C_ to use your communicator:
		..accept Urgent Business##7341 |goto Malgrave 1645,4079,-955
	step
		.talk Vigilant Acolyte Elzara##281374
		..turnin Journey to Malgrave##8971 |goto 1651,4082,-955
	step
		.talk High Priestess Raumia##287876
		..turnin Urgent Business##7341 |goto 1578,3997,-963
		..accept Assessing the Locals##7202 |goto 1578,3997,-963
	step
		.click Shinysand Oasis Taxi Kiosk##280600
		.' Get the _Shinysand Oasis_ taxi point |goto Malgrave 1593,4140,-970
		|confirm |q 7202
	step
		.talk Far-Trader Sumana##287919
		.' Speak to Far-Trader Sumana |q Assessing the Locals##7202/4 |goto 1587,4211,-979
		..accept The Town of Gravestone##7213 |goto 1587,4211,-979
	step
		.talk Chief Gorral##287922
		.' Speak to Chief Gorral |q Assessing the Locals##7202/1 |goto 1594,4239,-979
		..accept Clear the Beach##7207 |goto 1594,4239,-979
	step
		.talk Fry Cook Mohini##287906
		.' Speak to Fry Cook Mohini |q Assessing the Locals##7202/2 |goto 1618,4234,-979
		..accept Deep-Fry Everything##7205 |goto 1618,4234,-979
		..accept Probably a Delicacy##7206 |goto Malgrave 1618,4234,-979
	step
		.talk Sheriff Steambolt##287893
		.' Speak to Sheriff Steambolt |q Assessing the Locals##7202/3 |goto 1624,4214,-979
	...
	step
		...
		' _Go up_ the ramp |goto 1925,3976,-1040
	...
	step
		...
		.' _Leave_ the Novus wreckage |goto Malgrave 1916,3919,-1033 < 10
		.' _Go up_ the path here |goto Malgrave 1655,4263,-970 < 10
	...
	step
		'Press _C_ to use your communicator:
		..accept Surprise Prohibition##7175 |goto 1230,3957,-937
		..accept Bad News Brewing##7173 |goto 1230,3957,-937
		..accept Brewers in Bondage##7174 |goto 1230,3957,-937
	step
		.talk Marcella Vinos##282040
		.' Rescue Marcella Vinos |q Brewers in Bondage##7174/2 |goto Malgrave 1306,4046,-909
		.talk Primo Vinos##282018
		.' Rescue Primo Vinos |q Brewers in Bondage##7174/3 |goto 1306,4188,-915
		.talk Severus Vinos##282053
		.' Rescue Severus Vinos |q Brewers in Bondage##7174/1 |goto 1465,3896,-908
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Kill Gargleblast Marauders |q Bad News Brewing##7173/1 |goto 1437,3914,-906
		.click Slush Still##1203019
		.' Detonate Slush Stills |q Surprise Prohibition##7175/1 |goto 1376,3980,-909
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' _Jump across_ the newly formed rock bridge |goto 1281,4281,-927 < 10
		.' Kill Merciless Mek |q Blood for Brew##7176/2 |goto 1241,4372,-946
	step
		'Press _C_ to use your communicator:
	...
	step
		.' _Follow_ this path around the Exiles' base |goto Malgrave 1806,4071,-949 < 10
		'Press _C_ to use your communicator:
		..accept Boring But Vital Data##7219 |goto Malgrave 1944,4084,-945
		..accept Scrab Menace##7218 |goto 1944,4084,-945
	step
	...
	step
		.' _Follow_ the path around |goto Malgrave 2722,4219,-904
	...
	step
		.' _Go down_ the green set of stairs |goto 2969,4558,-811
	...
	step
		.' _Go through_ the doorway |goto 2881,4482,-999
		.click Eldan Fuel Rod Alpha##280720
		.' Activate Eldan Fuel Rod Alpha |q Eldan Power Source##7155/1 |goto Malgrave 2756,4433,-1008
	step
		.' _Go back_ to the main room |goto 2816,4482,-1007
		.' _Go through_ the opposite door |goto Malgrave 3039,4482,-998
	...
	step
		...
		..turnin War Profiteering##7418 |goto Malgrave 1647,2882,-820
	...
	step
		...
		.' _Follow the path_ up to Area 77 |goto Malgrave 1543,2864,-847 < 10
		.' _Follow this road_ east all the way to the Caravan |goto 1719,2814,-824 < 10
	...
	step
		...
		..turnin A Strange Old Pell##8548 |goto Malgrave 3057,3382,-828
	...
	step
		...
		.' Investigate the head-shaped idol |q Heresy Cubed##8568/1 |goto Malgrave 2985,3682,-843
		.' Survive the attacking Probes! |q Heresy Cubed##8568/2 |goto 2985,3682,-843
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Access the first Flamedancer Terminal |q Combing the Archives##8549/1 |goto 2662,3797,-870
	step
	...
	step
		...
		.' Access the fourth Flamedancer Terminal |q Combing the Archives##8549/4 |goto 2784,3902,-868
		.click Flamedancer Mainframe##290649
		.' Hack the Flamedancer Mainframe |q Combing the Archives##8549/5 |goto 2677,3873,-869
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Kill Flamedancer Pell |q Divine Retribution##8569/1 |goto 2650,3876,-869
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Kill Flamedancer Pyre-Callers |q Crushing the Pyre-Callers##8570/1 |goto 2420,3652,-863
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Locate the Elder Cube's hiding place |q A Great Discovery##8551/1 |goto 2233,3764,-868
	step
		'Press _C_ to use your communicator:
	...
	step
		'Press the icon on the bottom right of your action bar to:
		.' Recall to _Area 77_ - Transmat |goto 1648,2943,-815 < 10
		.talk Artemis Zin##290620
		..turnin The Elder Cube##7379 |goto 1658,2863,-820
]])