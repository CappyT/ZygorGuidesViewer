ZGV:RegisterGuide("Exiles\\Wilderrun (35-41)",
	...
	step
		.' Go up the ramp and follow the path in Pilgrim's Promenade |goto 4031,-2647,-801
		.click Lever##271429
	...
	step
		.click Lever##271426
		.' Click the Lever and press _Yes_ to leave the Secret Ops Center |goto 3768,-1346,-1104
		.' Follow the path through Pilgrim's Promenade back to Thayd |goto Thayd 3986,-2981,-890
	step
		.click Ship to Wilderrun##274903 |goto Farside 4011,-2311,-804
	...
	step
		...
		|confirm
	step
		.kill Warpwood Strangleroot##2976885 |tip More of both of these can be found around Fool's Hope; look for yellow circles on your minimap.
		.kill Warpwood Rootgrabber##2965419
	...
	step
		...
		.click Viscous Polymorph Potion##273371 |tip It is behind the large tree.
	...
	step
		.' Cross the big wooden bridge |goto 2367,-1910,-821
		.' Go up the ramp |goto 2297,-2035,-797
	...
	step
		.' Climb up the big tree trunk |goto 2304,-2456,-767 <10
		.' Jump onto the Airshroom |goto 2310,-2479,-743 <10
		.' Jump onto the second Airshroom |goto 2286,-2480,-723 <10
		.' Jump onto the final Airshroom |goto 2276,-2472,-691 <10
		.' Find a way up to Hunter's Hideaway |q Hidden Heights##6555/1 |goto 2262,-2476,-688
		.' Go up the elevator here |goto 2245,-2468,-696
	...
	step
		...
		.kill Mosswood Rotspewer##3442393 |tip Look for yellow dots on your minimap.
		.' Kill Mosswood Snoglugs |q Snoglugs on Logs##6357/1 |goto 1889,-2667,-818
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Collect Razortail Heads from Wildbranch and Tanglecrash razortails |q Raucous Razortail##6361/1 |goto 2488,-2564,-773
		.' Collect Razortail Heads from Wildbranch and Tanglecrash razortails |q Raucous Razortail##6361/1 |goto Wilderrun 2217,-2295,-741
	step
		'Press _C_ to use your communicator:
	...
	step
		.click Cassian Commonwealth Emblem##283267 |tip These are marked as orange cogs on your minimap.
		.' Search for clues around the Crash Site |q Dominion History Lesson##6238/1 |goto Wilderrun 2589,-2647,-771
	step
		'Press _C_ to use your communicator:
		..turnin Dominion History Lesson##6238
		..accept Defragmenting Data##6239
	step
		.talk Wildfall Corpse##279997
		..accept Finishing the Job##6407 |goto 2582,-2682,-768
	step
		.' Jump onto the Airshroom |goto 2596,-2687,-766
		.' Jump onto the Airshroom |goto 2625,-2714,-722
		.' Use Airshrooms to reach the Ship Wreckage |q Finishing the Job##6407/1 |goto 2692,-2724,-724
		.' Jump onto the Airshroom |goto 2695,-2731,-719
		.' Jump up the metal ledges |goto Wilderrun 2728,-2773,-685
	...
	step
		...
		.' Collect Primal Life Essence |q Ask the Pell##6241/1 |goto 2425,-2846,-766
	...
	step
		.' Jump up the stone head to get to the top |goto 1937,-2503,-789
		.' Inspect the Skullstone of the Osun |q Race for the Everpool##6174/2 |goto 1931,-2528,-765
		...
		.click Dorian Walker##273465
		.' Press _T_ to shout to Dorian Walker |q Race for the Everpool##6174/5 |goto 2153,-2745,-811
	step
		.' Jump up the leaves to climb the tree |goto Wilderrun 2162,-2752,-804
		.' Jump across to the second tree and continue up the leaves |goto 2186,-2743,-776
	...
	step
		...
		.' Jump down the hole |goto 1712,-3412,-760
	...
	step
		...
		.' Feed and acquire Feralclaw Cubs |q Taming the Wilds##6368/1 |goto Wilderrun 2591,-3072,-783
		.click Feralclaw Cub##5331112
		.' Feed and acquire Feralclaw Cubs |q Taming the Wilds##6368/1 |goto 2606,-3105,-782
	...
	step
		.' Seek out Freya the Handmaiden |q Wild Women of the Jungle##6242/1 |goto 2807,-2840,-764
		.' Defeat Freya the Handmaiden |q Wild Women of the Jungle##6242/2 |goto Wilderrun 2811,-2833,-764
	step
		'Press _C_ to use your communicator:
	...
	step
		.' Climb up the huge tree trunk |goto Wilderrun 2305,-2455,-767
		.' Jump onto the Airshroom |goto 2311,-2479,-750
		.' Jump onto the second Airshroom |goto 2282,-2480,-730
		.' Jump onto the final Airshroom |goto 2276,-2473,-693
		.talk Maggs the Maimer##271074
	...
	step
		...
		.' Collect pelts from Grizzlepaws |q Grizzled Giants##6359 |goto 2294,-2343,-759
	step
		'Press _C_ to use your communicator:
		..turnin Grizzled Giants##6359
		..accept The Big Game##6362
	step
		.kill 1 Barhun##306438
		.' Kill Barhun |q The Big Game##6362/1 |goto Wilderrun 2229,-2380,-776
		.kill 1 Eviscerator##301882
		.' Kill Eviscerator |q The Big Game##6362/2 |goto 2298,-2583,-793
	step
	...
	step
		.' Go up the wooden ramp |goto Wilderrun 2724,-3904,-789
	...
	step
		.kill 1 Drognar the Pulverizer##431826
	...
	step
		.talk Shinequester Andro##266408 |tip This may be acceptable through your Communicator too.
		..accept All Along the Watchtowers##7912 |goto 3256,-4157,-707
	step
		.' Go back to the huge staircase |goto 3291,-4161,-729 <10
		.' Follow the stairs up to this spot |goto 3449,-4164,-661 <10
		.' Follow this platform around |goto 3388,-4129,-661 <10
		.' Jump down here to the platform below |goto 3402,-4020,-663 <10
		.' Follow this path atop the wall as you kill Tower Guards |goto 3447,-3971,-721
	...
	step
		.' Go up the wooden ramp |goto Wilderrun 2723,-3905,-788
		.talk Adventurer Kiyai##266417
	...
	step
		.click Field Journal Page##270087
		.' Collect Researcher Anton to the containment specialist |q Side Effects##8076/2 |goto 2092,-4332,-763
	...
	step
		...
		.' Kill Corrupted Pumera |q Corrupted Companions##7785/2 |goto 1818,-4129,-766
	step
		'Press _C_ to use your communicator:
	...
	step
		...
		.' Visit the Shrine of Vengeance  |q In Her Footsteps##7789/2 |goto 1442,-4138,-703
	...
	step
		...
		.' Repair the Hybridization Complex Access Nodes |q The Gatekeeper##7760/3 |goto 1537,-3619,-674
		.click Hybridization Complex Access Node##277472
		.' Repair the Hybridization Complex Access Nodes |q The Gatekeeper##7760/3 |goto 1462,-3640,-675
		.click Hybridization Complex Access Node##269676
		.' Repair the Hybridization Complex Access Nodes |q The Gatekeeper##7760/3 |goto 1477,-3698,-674
		...
		.' Step through the teleporter to enter the Luminai Hybridization Complex |q The Gatekeeper##7760/4 |goto 1505,-3657,-672
	step
	...
	step
		.' Go through the doorway |goto Wilderrun 1669,-3731,-994
	...
	step
		.' Go back through the doorway |goto Wilderrun 1610,-3770,-998
		.click Enhancement Monitoring System##266328
		..turnin Better Living Through Science##7766 |goto Wilderrun 1639,-3720,-994
	step
		.' Step into the teleporter to leave the Luminai Hybridization Complex |goto 1639,-3632,-990
	...
	step
		.' Go across the first bridge |goto 2509,-5022,-764
		.' Cross the bridges to the Deepfall Spires |q The Path of Destruction##7767/2 |goto Wilderrun 2580,-5113,-767
		.' Head across the second bridge |goto 2595,-5100,-767
		.' Walk across this bridge |goto 2685,-4979,-774
		.' Go down the path and across the bridge |goto 2712,-4816,-774
		.' Walk up the pile of bones and jump into the Primal Air Anomaly
	...
	step
		.' Follow the path back around |goto Wilderrun 2971,-4835,-803
		.' Enter the cave |goto 3168,-5018,-803
		.' Press _C_ to use your communicator
	...
	step
		.' Cross the first bridge |goto 2958,-4842,-803 <10
		.' Go across the second bridge |goto 2807,-4967,-799 <10
		.' Cross the last bridge |goto 2666,-4797,-768 <10
		.talk Depot Agent Sakiro##266335
		..turnin Heartbreaker##7770 |goto Wilderrun 2463,-4797,-774
		..accept The Megadroids##7768 |goto 2463,-4797,-774
	step
		.' Enter the cave |goto Wilderrun 2372,-5101,-749
		.' Enter Primal Kinesis Lab 9 |q The Megadroids##7768/1 |goto Wilderrun 2357,-5160,-767
		.' Go through the door way |goto Wilderrun 3348,-4977,-1008
	...
	step
		.' Step into the teleporter to leave the Primal Kinesis Lab |goto Wilderrun 3394,-5087,-1007
		.talk Depot Agent Sakiro##266335
