...
ZygorGuidesViewer_L("Main", "enUS", function() local f = {
	...
	-- GENERAL
	["name"] = "<T TextColor=\"ffff8800\">Zygor Guides</T>",

	-- STARTUP
	['welcome_guides'] = "%d guides are loaded.",

	["message_errorloading_full"] = "<T TextColor=\"ffff4444\">Error</T> loading guide <T TextColor=\"ffaaffaa\">%s</T>\nline: %d   step: %s\ncode:<T TextColor=\"ffffeeaa\">%s <T TextColor=\"ffff0000\">=====</T><T TextColor=\"ffff8800\"> %s</T>",
	["message_errorloading_brief"] = "<T TextColor=\"ffff4444\">Error</T> loading guide <T TextColor=\"ffaaffaa\">%s</T>",
	["message_errorloading_critical"] = "<T TextColor=\"ffff4444\">CRITICAL Error</T> loading guide <T TextColor=\"ffaaffaa\">%s</T>\nError: %s\nLine: %d\nData: %s",
	["message_loadedguide"] = "Activated guide: <T TextColor=\"ffaaffaa\">%s</T>",
	["message_missingguide"] = "<T TextColor=\"ffff4444\">Missing</T> guide: <T TextColor=\"ffaaffaa\">%s</T>",
...
ZygorGuidesViewer_L("Option", "enUS", function() local f = {
	...
	["opt_showmapbutton"] = "Show Zygor button",
	["opt_showmapbutton_desc"] = "Show the Zygor button that toggles the viewer.",

	["opt_canmovemapbutton"] = "Movable Zygor button",
	["opt_canmovemapbutton_desc"] = "Enable dragging the Zygor button.",

	["opt_reset"] = "Reset Window",
	["opt_reset_desc"] = "Reset Guide Viewer to original position and size.",

	["opt_bugreports"] = "Generate Bug Reports",
